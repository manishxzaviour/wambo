...
{ // file name  0,1,2,3,4 <html,css,js,xml,text>
...
{ // write file f d 0,1,2, xml txt js
	switch (m)
	{
	case 0:
	{
		...
		file.println(xS + xCh[1] + xC);
		file.print(from);
		file.print(xE + xCh[1] + xC);
		file.println(xS + xCh[2] + xC);
		file.print(For);
		file.print(xE + xCh[2] + xC);
		file.println(xS + xCh[3] + xC);
		file.print(ton);
		file.print(xE + xCh[3] + xC);
		file.println(xS + xCh[4] + xC);
		file.print(toff);
		file.print(xE + xCh[4] + xC);
		file.println(xS + xCh[5] + xC);
		file.print(EleRate);
		file.print(xE + xCh[5] + xC);
		file.println(xS + xCh[6] + xC);
		file.print(EleSupply);
		file.print(xE + xCh[6] + xC);
		file.println(xS + xCh[7] + xC);
		file.print(savedE);
		file.print(xE + xCh[7] + xC);
		file.println(xS + xCh[8] + xC);
		file.print(savedM);
		file.print(xE + xCh[8] + xC);
		file.println(xS + xCh[9] + xC);
		file.print(date);
		file.print(xE + xCh[9] + xC);
		file.println(xS + xCh[10] + xC);
		file.print(weather);
		file.print(xE + xCh[10] + xC);
